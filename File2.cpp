...
#include <cstdlib>    // <--- ПОТРІБНО ДЛЯ system()
#include "lift.hpp"

using namespace std;

void clearScreen() {
    system("cls"); // Справжня команда очищення консолі
}
...
int main() {
    // --- МАГІЧНИЙ РЯДОК ДЛЯ УКРАЇНСЬКОЇ МОВИ ---
    system("chcp 1251 > nul");
    // Ця команда перемикає шрифт консолі на Windows-1251
    // -------------------------------------------
